...
final class Quiz {
    ...
    static public func start<Question, Answer: Equatable, Delegate: QuizDelegate >(questions: [Question], delegate: Delegate, correctAnswers: [Question: Answer]) -> Quiz where Delegate.Answer == Answer, Delegate.Question == Question {
