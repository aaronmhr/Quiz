...
class iOSViewControllerFactory: ViewControllerFactory {
    ...
    private func questionViewController(for question: Question<String>, value: String, allowsMultipleSelection: Bool, options: [String], answerCallback: @escaping (Set<String>) -> Void) -> QuestionViewController {
